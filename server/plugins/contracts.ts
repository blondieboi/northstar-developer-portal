...
export type PluginHealth = { id: string; status: 'disabled' | 'ready' | 'stale' | 'degraded'; message: string; surfaces: PluginSurface[] }
...
export type PortalPlugin = {
  ...
  collectService?: (service: ServiceRecord, config: Record<string, unknown>) => Promise<unknown>
