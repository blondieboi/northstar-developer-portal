...
describe('GitHub webhooks',()=>{
  ...
  it('routes workflow runs to plugin refresh',()=>{expect(pluginRefreshRequested('workflow_run','acme/service')).toBe(true);expect(pluginRefreshRequested('push','acme/service')).toBe(false);expect(pluginRefreshRequested('workflow_run')).toBe(false)})
})
